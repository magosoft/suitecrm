<?php
/* Smarty version 4.5.3, created on 2025-06-27 20:48:59
  from 'E:\Proyectos\crm.local\suitecrm\cache\themes\SuiteP\modules\Users\DetailView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_685ee79b312793_16653969',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f34366ddddf03fc6dd511c6f35772a04ce5ba9ad' => 
    array (
      0 => 'E:\\Proyectos\\crm.local\\suitecrm\\cache\\themes\\SuiteP\\modules\\Users\\DetailView.tpl',
      1 => 1751050139,
      2 => 'file',
    ),
  ),
...
function content_685ee79b312793_16653969 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'E:\\Proyectos\\crm.local\\suitecrm\\include\\Smarty\\plugins\\function.sugar_include.php','function'=>'smarty_function_sugar_include',),1=>array('file'=>'E:\\Proyectos\\crm.local\\suitecrm\\include\\Smarty\\plugins\\function.sugar_translate.php','function'=>'smarty_function_sugar_translate',),2=>array('file'=>'E:\\Proyectos\\crm.local\\suitecrm\\include\\Smarty\\plugins\\modifier.strip_semicolon.php','function'=>'smarty_modifier_strip_semicolon',),3=>array('file'=>'E:\\Proyectos\\crm.local\\suitecrm\\include\\Smarty\\plugins\\function.counter.php','function'=>'smarty_function_counter',),4=>array('file'=>'E:\\Proyectos\\crm.local\\suitecrm\\include\\Smarty\\plugins\\function.sugar_phone.php','function'=>'smarty_function_sugar_phone',),5=>array('file'=>'E:\\Proyectos\\crm.local\\suitecrm\\include\\Smarty\\plugins\\modifier.escape.php','function'=>'smarty_modifier_escape',),6=>array('file'=>'E:\\Proyectos\\crm.local\\suitecrm\\include\\Smarty\\plugins\\function.sugar_getjspath.php','function'=>'smarty_function_sugar_getjspath',),));
?>
...
<div class="buttons">
<input title="Editar" accessKey="E" name="Edit" id="edit_button" value="Editar" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $_smarty_tpl->tpl_vars['fields']->value['id']['value'];?>
...
<input name="delete" id="delete_button" title="Eliminar" type="button" class="button" onclick="confirmDelete();" value="Eliminar"/>
<input title="Restablecer Preferencias de Usuario" class="button" LANGUAGE="javascript" onclick="if(confirm('¿Está seguro de que desea restablecer todas las preferencias de este usuario?')) window.location='index.php?module=Users&action=resetPreferences&reset_preferences=true&record=<?php echo $_smarty_tpl->tpl_vars['fields']->value['id']['value'];?>
';" type="button" name="password" value="Restablecer Preferencias de Usuario"/>
<input title="Restablecer Página de Inicio" class="button" LANGUAGE="javascript" onclick="if(confirm('¿Está seguro de que desea reiniciar su Página de Inicio?')) window.location='index.php?module=Users&action=DetailView&reset_homepage=true&record=<?php echo $_smarty_tpl->tpl_vars['fields']->value['id']['value'];?>
...
<li><input title="Editar" accessKey="E" name="Edit" id="edit_button" value="Editar" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $_smarty_tpl->tpl_vars['fields']->value['id']['value'];?>
...
<li><input name="delete" id="delete_button" title="Eliminar" type="button" class="button" onclick="confirmDelete();" value="Eliminar"/></li>
<li><input title="Restablecer Preferencias de Usuario" class="button" LANGUAGE="javascript" onclick="if(confirm('¿Está seguro de que desea restablecer todas las preferencias de este usuario?')) window.location='index.php?module=Users&action=resetPreferences&reset_preferences=true&record=<?php echo $_smarty_tpl->tpl_vars['fields']->value['id']['value'];?>
';" type="button" name="password" value="Restablecer Preferencias de Usuario"/></li>
<li><input title="Restablecer Página de Inicio" class="button" LANGUAGE="javascript" onclick="if(confirm('¿Está seguro de que desea reiniciar su Página de Inicio?')) window.location='index.php?module=Users&action=DetailView&reset_homepage=true&record=<?php echo $_smarty_tpl->tpl_vars['fields']->value['id']['value'];?>
...
<div class="col-xs-12 col-sm-8 detail-view-field" type="enum" field="UserType" >
