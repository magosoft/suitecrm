...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_CALL_TIME' => 'Permitir la referencia del tiempo de la llamada está activado. (esto debería estar desactivado en php.ini)',
    ...
    'ERR_CHECKSYS_JSON_NOT_AVAILABLE' => "Las funciones asociadas con las librerías del Parser JSON que necesita SuiteCRM no se han encontrado. Posiblemente debas descomentar la extensión en el archivo php.ini,o recompilar con el binario correcto, dependiendo de tu versión de PHP. Busca en el manual de PHP para más información.",
